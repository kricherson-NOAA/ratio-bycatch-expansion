#This function creates bycatch ratios with bootstrapped confidence intervals (no expansion)
...
do_boot_ratio_multi <- function(ob_dat, strata, vessel_strata = strata, expfactor = "tgt_mt", bycatchspp_col = species, bycatchspp, bycatchunit = "dis_mt", seed = 42)
{
  require(dplyr)
  require(tidyr)
  require(rlang)
